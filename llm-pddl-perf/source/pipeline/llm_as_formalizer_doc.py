...
Parser.add_argument("--index_start", default="11", help="index to start generating result from (inclusive)")
...
def run_formalizer_gpt(domain, data, problem, model, doc, force_json=False):
    ...
    df_path = f'../../output/llm-as-formalizer/{domain}/{data}/{model}/doc/{problem}/{problem}_{model}_df.pddl'
    pf_path = f'../../output/llm-as-formalizer/{domain}/{data}/{model}/doc/{problem}/{problem}_{model}_pf.pddl'
